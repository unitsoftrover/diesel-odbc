...
use super::super::{ffi, Handle, Return};
...
where T: OdbcType<'a> 
{
    ...
    {
        get_partial_data::<T>(stmt, col_or_param_num, buffer, 0)
    }
}
    ...
    match result {
        ...
        ffi::SQL_SUCCESS_WITH_INFO => {
            ...
            if indicator == ffi::SQL_NO_TOTAL {
                ...
                return get_partial_data(stmt, col_or_param_num, buffer, initial_len - null_offset);
            } else {
